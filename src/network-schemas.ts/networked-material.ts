  ...
  serializeForStorage: function serializeForStorage(eid: EntityID) {
    return {
      ...
      data: {
        ...
        emissiveMapNid: APP.getString(
          read(NetworkedMaterial.emissiveMapNid, eid)
        ),
        emissiveIntensity: read(NetworkedMaterial.emissiveIntensity, eid),
        roughnessMapNid: APP.getString(
          read(NetworkedMaterial.roughnessMapNid, eid)
        ),
        roughness: read(NetworkedMaterial.roughness, eid),
        metalnessMapNid: APP.getString(
          read(NetworkedMaterial.metalnessMapNid, eid)
        ),
