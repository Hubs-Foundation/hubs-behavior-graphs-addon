...
const networkedObjectMaterialQuery = defineQuery([
  Networked,
  NetworkedObjectMaterial,
]);
const networkedObjectMaterialEnterQuery = enterQuery(
  networkedObjectMaterialQuery
);
const networkedObjectMaterialExitQuery = enterQuery(
  networkedObjectMaterialQuery
);
export function objectMaterialSystem(app: App) {
